...
import com.laioffer.onlineorder.entity.request.FavoriteRequestBody;
import com.laioffer.onlineorder.service.FavoriteService;
...
public class FavoriteController {
    ...
    public void setFavoriteItem(@RequestBody FavoriteRequestBody requestBody, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (session == null) { // no such session: user is not logged in
