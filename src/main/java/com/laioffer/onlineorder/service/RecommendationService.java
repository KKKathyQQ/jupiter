...
import com.laioffer.onlineorder.dao.FavoriteDao;
...
public class RecommendationService {
    ...
    // [Stream, Video, Clip]. Each key is corresponding to a list of Items objects,
    ...
    private List<Item> recommendByFavoriteHistory(Set<String> favoritedItemIds, List<String> favoritedGameIds, ItemType type) throws RecommendationException {
        ...
        // Search Twitch based on the favorite game IDs returned from the last step.
        outerloop:
